            ...
            <div class="col s12 l12 input-field" id="openMod">
                <div class="col s12 l12 input-field">
                    ...
                    <input type="hidden" name="page" value="client.jsp">
						          <input type="submit" class="btn white green-text" value="Generate new keys" >
					       </form>
              	</div>
...
%>
  ...
  <div class="parallax-container valign-wrapper" >
    <div class="container">
          ...
          <div class="row center">
            <div class="col s12 m12 l12">
              <h3 class="white-text">Send an image to the artist</h3>
              <br>
            </div>
          </div>
  ...
  <div class="container">
    <div class="section">
      ...
      <form enctype="multipart/form-data" action="CifrarServlet" method="POST">
        ...
        <div class="row center">
          <div class="col s12 m12 l12">
              <h4 class="blue-text">2) Download the decrypted img</h4>
          </div>
        </div>
        <div class="row center">
